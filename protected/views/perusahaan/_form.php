		...
		<?php $form=$this->beginWidget('CActiveForm', array(
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					...
					<?php echo $form->dropDownList($model, "kecamatan",
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<?php echo $form->dropDownList($model, "jenis_usaha",
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<?php echo $form->dropDownList($model,'jenis_pemodalan',array(''=>'-- Pilih Jenis Pemodalan --','Perorangan'=>'Perorangan','PMDN'=>'PMDN','PMA'=>'PMA','Swasta Nasional'=>'Swasta Nasional','BUMN'=>'BUMN','Koperasi'=>'Koperasi','Join Venture'=>'Join Venture'),array('class'=>'form-control')); ?>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<?php echo $form->dropDownList($model,'klasifikasi',array(''=>'-- Pilih Klasifikasi --','Besar'=>'Besar','Menengah'=>'Menengah','Sedang'=>'Sedang','Kecil'=>'Kecil','< Kecil'=>'< Kecil'),array('class'=>'form-control')); ?>
						</div>
