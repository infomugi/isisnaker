...
//BPJS
		 	...
		 	<div class="col-md-12">
		 		...
		 		<div class="alert alert-info" style="margin-bottom: 0!important;">
		 			<center>Laporan Repkapitulasi Perusahaan untuk <b>Kecamatan <?php echo $model->nama; ?></b> Berhasil di Buat ke Excel, <b><a href="./Laporan Perusahaan Per Kecamatan <?php echo $model->nama; ?>.xls"/>Download Laporan</a></b></center>
		 		</div>
		 		<HR>
		 		...
		 		$this->widget('EExcelWriter', array(
		 			...
		 			'title'        => 'EExcelWriter',
		 			'stream'       => FALSE,
		 			'fileName'     => 'Laporan Perusahaan Per Kecamatan '.$model->nama.'.xls',
		 			'columns'      => array(
